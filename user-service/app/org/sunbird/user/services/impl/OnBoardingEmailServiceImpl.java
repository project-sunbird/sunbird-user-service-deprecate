...
public class OnBoardingEmailServiceImpl implements OnBoardingEmailService {
  ...
  private static OnBoardingEmailService onBoardingEmailService = null;

  public static synchronized OnBoardingEmailService getInstance() {
    if (null == onBoardingEmailService) {
      onBoardingEmailService = new OnBoardingEmailServiceImpl();
    }
